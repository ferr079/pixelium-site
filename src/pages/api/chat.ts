...
- 4 Proxmox nodes (N5105 + Ryzen 7 7840HS + i7-2600K + i5-3470S), 48 LXC containers + 1 VM
...
- Automation: 42 Ansible playbooks, 34 hosts, Semaphore (manual runs) + Dagu (scheduled DAGs)
...
CTF PLATFORMS:
- Hack The Box: Hacker rank, #937 global, 30 machines, 121 flags
